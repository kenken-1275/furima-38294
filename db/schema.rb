...
ActiveRecord::Schema.define(version: 2022_08_06_063131) do
  ...
  create_table "buyers", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["dealing_id"], name: "index_buyers_on_dealing_id"
  end
  ...
  create_table "items", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.integer "area_id", null: false
    t.integer "arrival_time_id", null: false
    t.bigint "user_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  ...
  create_table "users", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.string "chinese_last_name", null: false
    t.string "chinese_first_name", null: false
  ...
  add_foreign_key "buyers", "dealings"
